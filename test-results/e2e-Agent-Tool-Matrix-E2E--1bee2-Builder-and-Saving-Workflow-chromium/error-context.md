...
Locator: locator('div.rounded-xl').filter({ hasText: 'Git Conflict Resolver' }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('div.rounded-xl').filter({ hasText: 'Git Conflict Resolver' }).first()
