...
- Name: e2e.spec.ts >> Agent Tool Matrix E2E Test Suite >> Selecting a tool card opens detailed view
- Location: tests/e2e.spec.ts:41:7
    ...
    - main [ref=e3]:
      ...
      - generic [ref=e45]:
        - generic [ref=e46]:
          ...
          - generic [ref=e52]:
            - img [ref=e53]
            - textbox "Search query" [active] [ref=e56]:
              - /placeholder: "Search Tools, Skills, Connectors, or by #tag"
              - text: Git Master
            - button "Clear search" [ref=e57] [cursor=pointer]:
              - img [ref=e58]
        - generic [ref=e61]:
          - img [ref=e62]
