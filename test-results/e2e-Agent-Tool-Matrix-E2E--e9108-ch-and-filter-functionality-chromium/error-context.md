...
- Name: e2e.spec.ts >> Agent Tool Matrix E2E Test Suite >> Search and filter functionality
...
Locator: locator('h3').filter({ hasText: 'Git Master' }).first()
Expected: visible
Timeout: 5000ms
...
- main:
  ...
  - textbox "Search query":
    ...
    - text: Git Master
  - button "Clear search"
  - heading "No Tools Found" [level=3]
  - paragraph: Try altering your search or filter pills, or create a custom tool.
